  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-ink/30 bg-white text-ink shadow-sm hover:border-ink/60 hover:bg-sand",
        secondary: "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "gradient-ocean text-white shadow-lg hover:shadow-xl hover:scale-[1.02] font-semibold",
        filter: "bg-white border border-border text-foreground hover:bg-secondary hover:border-primary transition-all",
        accent: "gradient-navy text-white shadow-md hover:shadow-lg hover:scale-[1.02]",
      },
      size: {
